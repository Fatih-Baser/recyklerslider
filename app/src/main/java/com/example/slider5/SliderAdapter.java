...
public class SliderAdapter extends RecyclerView.Adapter<SliderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        //int iconTint = ContextCompat.getColor(holder.itemView.getContext(), R.color.seffaf);
...
//            imageView.setColorFilter(ContextCompat.getColor(imageView.getContext(), R.color.seffaf));
